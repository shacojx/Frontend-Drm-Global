...
export function KycContent(props: Props) {
  ...
  const [shouldShowConfirmDialog, setShouldShowConfirmDialog] =
    useState<boolean>();
  const [shouldShowPictureDialog, setShouldShowPictureDialog] =
    useState<boolean>();
      ...
      renderCell: (params: GridRenderCellParams) => {
        return (
          <div className={'flex flex-row gap-3'}>
            <button
              onClick={handleClickReject.bind(undefined, params.row.id)}
              className={
