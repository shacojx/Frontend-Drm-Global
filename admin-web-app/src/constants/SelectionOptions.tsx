...
export const INDUSTRY_INFOS: OptionInfo<Industry>[] = [
  {
    value: 'Accounting and tax preparation',
    label: 'Accounting and tax preparation',
  },
  ...
  {
    value: 'Other health and fitness services',
    label: 'Other health and fitness services',
  },
  ...
  {
    value: 'Private investment companies',
    label: 'Private investment companies',
  },
  {
    value: 'Legal services including law',
    label: 'Legal services including law',
  },
