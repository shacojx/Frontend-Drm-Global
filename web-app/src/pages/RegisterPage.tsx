...
import { FormFieldSelectCompanyType } from "../components/FormFieldSelectCompanyType";
import { FormFieldSelectNation } from "../components/FormFieldSelectNation";
...
export function RegisterPage(props: Props) {
  ...
  return <PageLayoutOneForm>
    ...
    <FormFieldSelectNation placeholder={translation.t('Choose nation')} value={nation} onChange={handleChangeNation}/>
...
function AccountInformationStep(props: AccountInformationStepProps) {
  ...
  return <div className="flex flex-col gap-y-8">
    ...
    <FormFieldSelectCompanyType placeholder="LLC" value={companyType} onChange={setCompanyType} />
    <button
